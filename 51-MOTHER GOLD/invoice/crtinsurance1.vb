...
Public Class crtinsurance1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtinsurance1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtinsurance1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtinsurance1 = New crtinsurance1()
        rpt.Site = Me.Site
        Return rpt
    End Function
