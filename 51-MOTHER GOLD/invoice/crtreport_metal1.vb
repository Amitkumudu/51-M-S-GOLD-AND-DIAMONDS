...
Public Class crtreport_metal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtreport_metal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtreport_metal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtreport_metal = New crtreport_metal()
        rpt.Site = Me.Site
        Return rpt
    End Function
