...
Public Class crtrentrcpt_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.crtrentrcpt_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrtrentrcpt_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtrentrcpt_1 = New crtrentrcpt_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
